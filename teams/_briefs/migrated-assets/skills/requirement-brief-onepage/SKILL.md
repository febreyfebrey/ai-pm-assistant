---
name: requirement-brief-onepage
description: Produce concise one-page requirement briefs from Jira tickets that give devs enough context for rough size estimation (not a full PRD). Use when PM asks to analyze a requirement, write a brief, or prepare a ticket for estimation handoff.
---
